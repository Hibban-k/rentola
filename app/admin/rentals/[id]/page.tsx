...
import { Car, Calendar, MapPin, User, ArrowLeft, Shield } from "lucide-react";
...
export default function AdminRentalDetailPage({
    ...
    // Type assertion for nested populated fields if they exist but aren't in the strict Rental interface
    // In a real app, we should update the Rental interface to reflect populated renterId
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    const renter = rental?.renterId as any;
                ...
                <div className="grid gap-6 lg:grid-cols-3">
                        ...
                        <div className="bg-card border border-border rounded-2xl p-6">
                            ...
                            <div className="p-4 bg-muted/50 rounded-xl space-y-2">
                                ...
                                <div className="flex justify-between">
                                    ...
                                    <span className="font-mono text-sm">{typeof rental.renterId === 'string' ? rental.renterId : renter?._id}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="bg-blue-500/10 border border-blue-500/20 rounded-xl p-4 flex items-start gap-3">
                            ...
                            <div>
                                <p className="font-medium text-blue-500">Admin View</p>
                                <p className="text-sm text-muted-foreground mt-1">
                                    You are viewing this rental as an administrator.
                                </p>
                            </div>
                        </div>
                    </div>
